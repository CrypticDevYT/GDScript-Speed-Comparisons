...
func _on_BubbleSortButton_pressed():
	var take_avg_pressed = $VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer3/TakeAvgCheck.pressed
	var static_type_pressed= false
	var amt = $VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer/SpinBox.value
