...
func bubblesort_static_typed(array: PackedInt32Array) -> void:
	var len: int = array.size()
	for i: int in range(0, len):
		var swapped:bool = false
		for j: int in range(0, len - i - 1):
...
func quicksort_static_typed(array: PackedInt32Array) -> void:
...
func partition_static_typed(array: PackedInt32Array, low: int, high: int) -> int:
...
func get_avg_int_arr(array: PackedInt32Array) -> int:
	var sum: int = 0
	for i:int in array:
		sum += i
...
func _on_bubble_sort_button_pressed() -> void:
	var take_avg_pressed:bool = $VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer3/TakeAvgCheck.button_pressed
	var static_type_pressed:bool = $VBoxContainer/HBoxContainer/VBoxContainer/HBoxContainer2/StaticTypeCheck.button_pressed
